      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
        ...
        <ScrollReveal delay={0.08}>
          <TiltWrap>
            <motion.div
              whileHover={{ y: -6 }}
              className="relative rounded-[20px] overflow-hidden bg-white/[0.035] border border-white/[0.08] transition-all duration-[550ms] hover:border-white/[0.18] hover:shadow-[0_0_60px_rgba(0,200,255,0.08),0_24px_80px_rgba(0,0,0,0.3)]"
            >
              <div className="aspect-[16/10] bg-gradient-to-br from-neon-orange/10 via-neon-gold/5 to-neon-cyan/8 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-[1] text-center">
                  <p className="font-display italic text-4xl text-white/20">IdeaFlash</p>
                  <p className="font-body text-[11px] tracking-[0.2em] text-text-muted mt-2 uppercase">灵感胶囊</p>
                </div>
              </div>
        ...
        <ScrollReveal delay={0.16}>
          <TiltWrap>
            <motion.div
              whileHover={{ y: -6 }}
              className="relative rounded-[20px] overflow-hidden bg-white/[0.035] border border-white/[0.08] transition-all duration-[550ms] hover:border-white/[0.18] hover:shadow-[0_0_60px_rgba(216,76,255,0.08),0_24px_80px_rgba(0,0,0,0.3)]"
            >
