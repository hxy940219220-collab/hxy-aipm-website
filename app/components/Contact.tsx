            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <Magnet padding={80} magnetStrength={3}>
                <a
                  ...
                  className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-full font-body text-[13.5px] font-medium tracking-[0.04em] no-underline bg-white text-black border-none transition-all duration-[450ms] hover:shadow-[0_0_48px_rgba(0,200,255,0.45)]"
                >
              ...
              <Magnet padding={80} magnetStrength={2}>
                <a
                  ...
                  className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-full font-body text-[13.5px] font-medium tracking-[0.04em] text-white no-underline bg-white/[0.05] border border-white/[0.16] backdrop-blur-[10px] transition-all duration-[450ms] hover:border-neon-pink hover:bg-white/[0.1] hover:shadow-[0_0_32px_rgba(216,76,255,0.15)]"
                >
